...
typedef void QRViewCallback(String val);

class QRViewExample extends StatefulWidget {
  QRViewCallback callback;
...
class _QRViewExampleState extends State<QRViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Scan QR Code')), body: Container());
    // appBar: AppBar(title: Text('Scan QR Code')), body: _cateFutureData());
  }
  ...
  //               ? Center(
  //                   child: Text("Need Camera Permission To Scan QR Code"),
  //                 )
  //               : getBody();
